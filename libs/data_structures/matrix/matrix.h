#ifndef INC_2NDSEMESTR_MATRIX_H
#define INC_2NDSEMESTR_MATRIX_H
...
// выполняет сортировку выбором столбцов матрицы
// m по неубыванию значения функции criteria применяемой для столбцов
